...
for i in range(3):
    ...
    #Error Metrics
    with open(out+'output1pinn_{}_{}.txt'.format(l[i],neuron1), 'w') as f:
        print("Error metrics for layers ={} with fixed neuron ={}".format(l[i],neuron1), file=f)
        print("=======================================================\n", file=f)
...
for i in range(3):
    ...
    rel =np.sum((test_actual-test_pred)**2/(test_actual**2))
    #Error Metrics
    with open(out+'output1pinn_{}_{}.txt'.format(l[i],neuron2), 'w') as f:
        print("Error metrics for layers ={} with fixed neuron ={}".format(l[i],neuron2), file=f)
        print("=======================================================\n", file=f)
        print('RMSE',rmse, file=f)
        print('MAPE',mape, file=f)
        print('EV', ev, file=f)
