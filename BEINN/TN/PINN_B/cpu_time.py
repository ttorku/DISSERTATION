...
for i in range(3):
    layers =[1] +l*[neuron] +[1]
    model = SIRD(II/N0,RR/N0,SS/N0,DD/N0, T,1,layers,eps[i])
    model.train(40000)
    #predict output
    ...
    #Error Metrics
    with open(out+'cpu_{}_{}_{}.txt'.format(eps[i], l,neuron), 'w') as f:
        print("Error metrics for  epilson={} and layers ={} with fixed neuron ={}".format(eps[i], l,neuron), file=f)
        print("=======================================================\n", file=f)
