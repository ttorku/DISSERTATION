...
for i in range(3):
    layers =[1] +l[i]*[neuron1] +[1]
    model = SIRD(II/N0,RR/N0,SS/N0,DD/N0, T,1,layers,eps1)
    model.train(40000)
    #predict output
    ...
    #Error Metrics
    with open(out+'output_{}_{}_{}.txt'.format(eps1, l[i],neuron1), 'w') as f:
        print("Error metrics for  epilson={} and layers ={} with fixed neuron ={}".format(eps1, l[i],neuron1), file=f)
        print("=======================================================\n", file=f)
...
neuron2 =32
for i in range(3):
    layers =[1] +l[i]*[neuron2] +[1]
    model = SIRD(II/N0,RR/N0,SS/N0,DD/N0, T,1,layers,eps2)
    model.train(40000)
    #predict output
    TT = np.arange(0,length).reshape(length,1)
    s_p,i_p,r_p,d_p,beta_p, gamma_p, delta_p, compliance_p= model.predict(TT)
    ...
    rel =np.sum((test_actual-test_pred)**2/(test_actual**2))
    #Error Metrics
    with open(out+'output_{}_{}_{}.txt'.format(eps2, l[i],neuron2), 'w') as f:
        print("Error metrics for  epilson={} and layers ={} with fixed neuron ={}".format(eps2, l[i],neuron2), file=f)
        print("=======================================================\n", file=f)
        print('RMSE',rmse, file=f)
        print('MAPE',mape, file=f)
        print('EV', ev, file=f)
...
neuron3 =64
for i in range(3):
    layers =[1] +l[i]*[neuron3] +[1]
    model = SIRD(II/N0,RR/N0,SS/N0,DD/N0, T,1,layers,eps3)
    model.train(40000)
    #predict output
    TT = np.arange(0,length).reshape(length,1)
    s_p,i_p,r_p,d_p,beta_p, gamma_p, delta_p, compliance_p= model.predict(TT)
    ...
    rel =np.sum((test_actual-test_pred)**2/(test_actual**2))
    #Error Metrics
    with open(out+'output_{}_{}_{}.txt'.format(eps3, l[i],neuron3), 'w') as f:
        print("Error metrics for  epilson={} and layers ={} with fixed neuron ={}".format(eps3, l[i],neuron3), file=f)
        print("=======================================================\n", file=f)
        print('RMSE',rmse, file=f)
        print('MAPE',mape, file=f)
        print('EV', ev, file=f)
...
neuron4 =64
for i in range(3):
    layers =[1] +l[i]*[neuron4] +[1]
    model = SIRD(II/N0,RR/N0,SS/N0,DD/N0, T,1,layers,eps4)
    model.train(40000)
    #predict output
    TT = np.arange(0,length).reshape(length,1)
    s_p,i_p,r_p,d_p,beta_p, gamma_p, delta_p, compliance_p= model.predict(TT)
    ...
    rel =np.sum((test_actual-test_pred)**2/(test_actual**2))
    #Error Metrics
    with open(out+'output_{}_{}_{}.txt'.format(eps4, l[i],neuron4), 'w') as f:
        print("Error metrics for  epilson={} and layers ={} with fixed neuron ={}".format(eps4, l[i],neuron4), file=f)
        print("=======================================================\n", file=f)
        print('RMSE',rmse, file=f)
        print('MAPE',mape, file=f)
        print('EV', ev, file=f)
...
neuron5 =64
for i in range(3):
    layers =[1] +l[i]*[neuron5] +[1]
    model = SIRD(II/N0,RR/N0,SS/N0,DD/N0, T,1,layers,eps5)
    model.train(40000)
    #predict output
    TT = np.arange(0,length).reshape(length,1)
    s_p,i_p,r_p,d_p,beta_p, gamma_p, delta_p, compliance_p= model.predict(TT)
    ...
    rel =np.sum((test_actual-test_pred)**2/(test_actual**2))
    #Error Metrics
    with open(out+'output_{}_{}_{}.txt'.format(eps5, l[i],neuron5), 'w') as f:
        print("Error metrics for  epilson={} and layers ={} with fixed neuron ={}".format(eps5, l[i],neuron5), file=f)
        print("=======================================================\n", file=f)
        print('RMSE',rmse, file=f)
        print('MAPE',mape, file=f)
        print('EV', ev, file=f)
...
neuron6 =32
for i in range(3):
    layers =[1] +l[i]*[neuron6] +[1]
    model = SIRD(II/N0,RR/N0,SS/N0,DD/N0, T,1,layers,eps6)
    model.train(40000)
    #predict output
    TT = np.arange(0,length).reshape(length,1)
    s_p,i_p,r_p,d_p,beta_p, gamma_p, delta_p, compliance_p= model.predict(TT)
    ...
    rel =np.sum((test_actual-test_pred)**2/(test_actual**2))
    #Error Metrics
    with open(out+'output_{}_{}_{}.txt'.format(eps6, l[i],neuron6), 'w') as f:
        print("Error metrics for  epilson={} and layers ={} with fixed neuron ={}".format(eps6, l[i],neuron6), file=f)
        print("=======================================================\n", file=f)
        print('RMSE',rmse, file=f)
        print('MAPE',mape, file=f)
        print('EV', ev, file=f)
