...
class SIRD:
    def __init__(self, I, R, S,T,N0, layers, eps, h, eta, v,alpha, k):
        self.t = T
        self.I = I
        self.R = R
        self.S = S
        ...
        self.S_pred, self.I_pred, self.R_pred=self.net_sird(self.t_tf)
...
model = SIRD(II/N0,RR/N0,SS/N0, T,1,layers, eps, h, eta, v,alpha, k)
model.train(120000)
