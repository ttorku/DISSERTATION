...
np.savetxt(out +'S_true_{}_{}_{}_{}_{}.txt'.format(eta, h, v,k, sigma),S_original.flatten().tolist())
np.savetxt(out +'I_true_{}_{}_{}_{}_{}.txt'.format(eta, h, v, k, sigma),I_original.flatten().tolist())
np.savetxt(out +'R_true_{}_{}_{}_{}_{}.txt'.format(eta, h, v, k, sigma),R_original.flatten().tolist())
np.savetxt(out +'S_pred_{}_{}_{}_{}_{}.txt'.format(eta, h, v, k, sigma),s_p.flatten().tolist())
np.savetxt(out +'I_pred_{}_{}_{}_{}_{}.txt'.format(eta, h, v, k, sigma),i_p.flatten().tolist())
np.savetxt(out +'R_pred_{}_{}_{}_{}_{}.txt'.format(eta, h, v, k, sigma),r_p.flatten().tolist())
np.savetxt(out +'gsi_pred_{}_{}_{}_{}_{}.txt'.format(eta, h, v, k, sigma),gsi_pred.flatten().tolist())
np.savetxt(out +'gsi_act_{}_{}_{}_{}_{}.txt'.format(eta, h, v, k, sigma),gsi_act.flatten().tolist())
#loss
np.savetxt(out +'lossData_{}_{}_{}_{}_{}.txt'.format(eta, h, v, k, sigma),model.loss_data)
np.savetxt(out +'lossPhy_{}_{}_{}_{}_{}.txt'.format(eta, h, v,k, sigma),model.loss_phys)
np.savetxt(out +'total_loss_{}_{}_{}_{}_{}.txt'.format(eta, h, v, k, sigma),model.total_loss)
...
#Error Metrics
with open(out+'gsi_{}_{}_{}_{}_{}.txt'.format(eta, h, v, k, sigma), 'w') as f:
    print("Error metrics for  eta={} and h ={} with v ={} and k={} for sigma={}".format(eta, h, v, k, sigma), file=f)
    print("=======================================================\n", file=f)
